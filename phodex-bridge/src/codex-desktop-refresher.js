...
class CodexDesktopRefresher {
  ...
  // Uses a full app relaunch for discrete phone-authored changes when explicitly requested,
  // but keeps throttled rollout-growth refreshes on the lighter route-bounce path.
